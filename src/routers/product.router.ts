...
router.put('/update', upload,  updateProductSchema,validateRequest,verifyToken,updateProduct);
router.post('/create', upload, createProductSchema, validateRequest,verifyToken,createProduct);
